                ...
                <div class="bg-soft-primary">
                    <div class="row">
                        ...
                        <div class="col-5 align-self-end">
                            <img src="{{asset('/')}}blogAdmin/assets/images/profile-img.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="{{asset('/')}}blogAdmin/assets/images/users/avatar-1.jpg" alt="" class="img-thumbnail rounded-circle">
                            </div>
